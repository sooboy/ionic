...
const deepLinker = require("../deep-linker");
...
describe('DeepLinker', () => {
    ...
    describe('loadViewFromSegment', () => {
        it('should call done if the view is the same as the last one in the stack', () => {
            ...
            spyOn(nav, 'push');
            spyOn(nav, 'popTo');
            linker._loadViewForSegment(nav, segment, mock_providers_1.noop);
        ...
        it('should call select when its a Tabs nav', () => {
            ...
            const tabOne = mock_providers_1.mockTab(tabs);
            ...
            spyOn(tabs, 'select');
            linker._loadViewForSegment(tabOne, segment, mock_providers_1.noop);
    ...
    describe('initViews', () => {
        it('should return an array with one view controller when there isnt default history', (done) => {
            const knownSegment = {
                id: 'idk',
                name: 'viewone',
                data: {},
    ...
    describe('urlChange', () => {
        ...
        it('should go to root when url is /', () => {
            ...
            spyOn(linker, '_historyPush');
            const navControllerOne = mock_providers_1.mockNavController();
            const navControllerTwo = mock_providers_1.mockNavController();
            linker._app.getActiveNavContainers = () => {
        ...
        it('should load the views for the segments', () => {
            ...
            const childNavTwo = mock_providers_1.mockTabs();
            childNavTwo.parent = navControllerTwo;
            const tabOne = mock_providers_1.mockTab(childNavTwo);
            tabOne.setSelected(true);
            mock_providers_1.mockTab(childNavTwo);
    ...
    describe('navChange', () => {
        it('should immediately return when an active nav container is a tabs component', () => {
            linker._app.getActiveNavContainers = () => {
                return [mock_providers_1.mockTabs()];
            };
    ...
    describe('getSegmentFromNav', () => {
        it('should use the name of the nav when it exists', () => {
            ...
            const view1 = mock_providers_1.mockView(mock_providers_1.MockView1);
            mock_providers_1.mockViews(mockNav, [view1]);
    ...
    describe('_loadViewForSegment', () => {
        ...
        it('should remain on the last view in the stack if its found', () => {
            ...
            spyOn(wrapper, wrapper.done.name);
            const navCtrl = mock_providers_1.mockNavController();
            const view1 = mock_providers_1.mockView(mock_providers_1.MockView1);
            view1.id = 'MockPage1';
            const view2 = mock_providers_1.mockView(mock_providers_1.MockView1);
            view2.id = 'MockPage2';
            mock_providers_1.mockViews(navCtrl, [view1, view2]);
            spyOn(navCtrl, 'popTo');
    ...
    var serializer;
    beforeEach(() => {
        let linkConfig = mock_providers_1.mockDeepLinkConfig();
        serializer = new url_serializer_1.UrlSerializer(mock_providers_1.mockApp(), linkConfig);
        let moduleLoader = mock_providers_1.mockModuleLoader();
        let baseCfr = null;
        linker = new deepLinker.DeepLinker(mock_providers_1.mockApp(), serializer, mock_providers_1.mockLocation(), moduleLoader, baseCfr);
    });
});
