...
class MenuController {
     ...
     */
    _register(menu) {
        util_1.assert(this._menus.indexOf(menu) < 0, 'menu was already registered');
     ...
     */
    _unregister(menu) {
        util_1.assert(this._menus.indexOf(menu) >= 0, 'menu is not registered');
     ...
     */
    _setActiveMenu(menu) {
        util_1.assert(menu.enabled, 'menu must be enabled');
        util_1.assert(this._menus.indexOf(menu) >= 0, 'menu is not registered');
