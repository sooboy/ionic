...
class IOSTransition extends page_transition_1.PageTransition {
    init() {
        super.init();
        const plt = this.plt;
        ...
        if (enteringView) {
            ...
            // entering content
            const enteringContent = new animation_1.Animation(plt, enteringView.contentRef());
            ...
            if (enteringHasNavbar) {
                ...
                const enteringTitle = new animation_1.Animation(plt, enteringNavbarEle.querySelector('ion-title'));
                const enteringNavbarItems = new animation_1.Animation(plt, enteringNavbarEle.querySelectorAll('ion-buttons,[menuToggle]'));
                const enteringNavbarBg = new animation_1.Animation(plt, enteringNavbarEle.querySelector('.toolbar-background'));
                ...
                if (backDirection) {
                    ...
                    if (enteringView.enableBack()) {
                        ...
                        enteringBackButton
                            .beforeAddClass(SHOW_BACK_BTN_CSS)
                            .fromTo(OPACITY, 0.01, 1, true);
                        const enteringBackBtnText = new animation_1.Animation(plt, enteringNavbarEle.querySelector('.back-button-text'));
        ...
        if (leavingView && leavingView.pageRef()) {
            ...
            const leavingContent = new animation_1.Animation(plt, leavingView.contentRef());
            ...
            if (leavingHasNavbar) {
                ...
                const leavingNavBar = new animation_1.Animation(plt, leavingNavbarEle);
                const leavingTitle = new animation_1.Animation(plt, leavingNavbarEle.querySelector('ion-title'));
                const leavingNavbarItems = new animation_1.Animation(plt, leavingNavbarEle.querySelectorAll('ion-buttons,[menuToggle]'));
                const leavingNavbarBg = new animation_1.Animation(plt, leavingNavbarEle.querySelector('.toolbar-background'));
                const leavingBackButton = new animation_1.Animation(plt, leavingNavbarEle.querySelector('.back-button'));
                leavingNavBar
                    .add(leavingTitle)
                ...
                if (backDirection) {
                    ...
                    leavingNavbarBg
                        .beforeClearStyles([OPACITY])
                        .fromTo(TRANSLATEX, CENTER, (plt.isRTL ? '-100%' : '100%'));
                    let leavingBackBtnText = new animation_1.Animation(plt, leavingNavbarEle.querySelector('.back-button-text'));
