...
const url_serializer_1 = require("../url-serializer");
...
describe('UrlSerializer', () => {
    describe('serializeComponent', () => {
        it('should create segment when config has multiple links to same component', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'viewone', segment: 'view' };
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view/:param1' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view/:param1/:param2' };
            ...
            serializer.serializeComponent(nav, mock_providers_1.MockView1, null);
        ...
        it('should create tab segment if component found in deep links', () => {
            ...
            const tab = mock_providers_1.mockTab(tabs);
            serializer.serializeComponent(tab, mock_providers_1.MockView1, null);
            expect(serializer._createSegment).toHaveBeenCalled();
        });
    });
    ...
    describe('navGroupStringtoObjects', () => {
        it('should convert the nav group strings to objects', () => {
            ...
            const objects = url_serializer_1.navGroupStringtoObjects(urlChunks);
    ...
    describe('serialize', () => {
        it('should serialize multiple segments into a url with explicit prefixs', () => {
            let paths = [
                { type: 'nav', navId: 'whatup', secondaryId: null, id: 'some/url/chunks', name: 'viewOne', component: mock_providers_1.MockView1, data: null, requiresExplicitNavPrefix: true },
                { type: 'tabs', navId: 't1', secondaryId: 'tab-one', id: 'some/more/url/chunks', name: 'viewTwo', component: mock_providers_1.MockView1, data: null, requiresExplicitNavPrefix: true }
            ];
        ...
        it('should serialize multiple segments into a url', () => {
            let paths = [
                { type: 'nav', navId: 'whatup', secondaryId: null, id: 'some/url/chunks', name: 'viewOne', component: mock_providers_1.MockView1, data: null },
                { type: 'tabs', navId: 't1', secondaryId: 'tab-one', id: 'some/more/url/chunks', name: 'viewTwo', component: mock_providers_1.MockView1, data: null }
            ];
            const result = serializer.serialize(paths);
    ...
    describe('createMatchedData', () => {
        it('should get data from multiple parts', () => {
            ...
            let link = {
                segmentParts: ['a', ':name', ':breed'], segmentPartsLen: 3, component: mock_providers_1.MockView1
            };
            let data = url_serializer_1.createMatchedData(matchedUrlParts, link);
        ...
        it('should get data within the config link path', () => {
            ...
            let link = {
                segmentParts: ['a', ':id', ':name', 'd'], segmentPartsLen: 4, component: mock_providers_1.MockView1
            };
            let data = url_serializer_1.createMatchedData(matchedUrlParts, link);
        ...
        it('should get data within the config link path', () => {
            ...
            let link = {
                segmentParts: ['a', ':num'], segmentPartsLen: 2, component: mock_providers_1.MockView1
            };
            let data = url_serializer_1.createMatchedData(matchedUrlParts, link);
        ...
        it('should get uri decode data', () => {
            ...
            let link = {
                segmentParts: [':name'], segmentPartsLen: 1, component: mock_providers_1.MockView1
            };
            let data = url_serializer_1.createMatchedData(matchedUrlParts, link);
            expect(data.name).toEqual(char);
        });
        it('should get null data if nothing in the url', () => {
            ...
            let link = {
                segmentParts: ['a'], segmentPartsLen: 1, component: mock_providers_1.MockView1
            };
            let data = url_serializer_1.createMatchedData(matchedUrlParts, link);
    ...
    describe('formatUrlPart', () => {
        it('should encodeURIComponent', () => {
            ...
            expect(url_serializer_1.formatUrlPart(name)).toEqual(encoded);
        });
        it('should not allow restricted characters', () => {
            expect(url_serializer_1.formatUrlPart('!!!Restricted \'?$,.+"*^|/\#%`><;:@&[]=! Characters!!!')).toEqual('restricted-characters');
        });
        it('should trim and replace spaces with dashes', () => {
            expect(url_serializer_1.formatUrlPart('   This is the name   ')).toEqual('this-is-the-name');
        });
        it('should not have multiple dashes', () => {
            expect(url_serializer_1.formatUrlPart('Contact Detail Page')).toEqual('contact-detail-page');
        });
        it('should change to pascal case for multiple words', () => {
            expect(url_serializer_1.formatUrlPart('ContactDetailPage')).toEqual('contact-detail-page');
        });
        it('should change to pascal case for one work', () => {
            expect(url_serializer_1.formatUrlPart('View1')).toEqual('view1');
        });
    });
    describe('findLinkByComponentData', () => {
        it('should get matching link by component w/ data and multiple links using same component, 2 matches', () => {
            ...
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view/:param1' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view/:param1/:param2' };
            let links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            let foundLink = url_serializer_1.findLinkByComponentData(links, mock_providers_1.MockView1, {
                param1: false,
                param2: 0,
                param3: 0
            });
        ...
        it('should get matching link by component w/ no data and multiple links using same component', () => {
            ...
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view/:param1/:param2' };
            let links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            let foundLink = url_serializer_1.findLinkByComponentData(links, mock_providers_1.MockView1, null);
            expect(foundLink.name).toEqual('viewone');
        });
        it('should get matching link by component data and link data', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'viewone', segment: 'view' };
            const link2 = { component: mock_providers_1.MockView2, name: 'viewtwo', segment: 'view/:param1' };
            const link3 = { component: mock_providers_1.MockView3, name: 'viewthree', segment: 'view/:param1/:param2' };
            let links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            let foundLink = url_serializer_1.findLinkByComponentData(links, mock_providers_1.MockView3, {
                param1: null,
                param2: false,
                param3: 0,
                param4: 'hello'
        ...
        it('should get no matching link by component without data, but link requires data', () => {
            ...
            const link3 = { component: mock_providers_1.MockView3, name: 'viewthree', segment: 'view/:param1/:param2' };
            let links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            let foundLink = url_serializer_1.findLinkByComponentData(links, mock_providers_1.MockView2, null);
    ...
    describe('normalizeLinks', () => {
        it('should sort with four parts, the most number of paths w/out data first', () => {
            ...
            let sortedLinks = url_serializer_1.normalizeLinks(links);
        ...
        it('should create a parts from the name', () => {
            ...
            expect(url_serializer_1.normalizeLinks(links)[0].segmentParts).toEqual(['somename']);
        });
    ...
    describe('createSegmentFromName', () => {
        it('should match by the links string name', () => {
            const mockNav = mock_providers_1.mockNavController();
    ...
    describe('urlToNavGroupStrings', () => {
        it('should get an array with a single piece url back', () => {
            const url = 'test';
            const result = url_serializer_1.urlToNavGroupStrings(url);
    ...
    describe('convertUrlToDehydratedSegments', () => {
        it('it should return a vanilla single segment', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'viewone', segment: 'view-one' };
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view-two' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view-three' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            const url = 'view-two';
            const segmentPairs = url_serializer_1.convertUrlToDehydratedSegments(url, links);
        ...
        it('it should return a data-driven single segment', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'viewone', segment: 'view-one' };
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view-two/paramOne/:paramOne/paramTwo/:paramTwo' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view-three' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3]);
        ...
        it('it should return a vanilla set of segments', () => {
            ...
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view-two' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view-three' };
            const link4 = { component: mock_providers_1.MockView1, name: 'viewfour', segment: 'view-four' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3, link4]);
        ...
        it('it should return a data-driven set of segments', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'viewone', segment: 'view-one/paramOne/:paramOne/paramTwo/:paramTwo' };
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view-two/user/:userId' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view-three/:itemId' };
            const link4 = { component: mock_providers_1.MockView1, name: 'viewfour', segment: 'view-four' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3, link4]);
        ...
        it('should return a segment w/ secondary id even if it has the same name as a router link basic', () => {
            ...
            const link2 = { component: mock_providers_1.MockView1, name: 'viewtwo', segment: 'view-two/user/:userId' };
            const link3 = { component: mock_providers_1.MockView1, name: 'viewthree', segment: 'view-three/:itemId' };
            const link4 = { component: mock_providers_1.MockView1, name: 'schedule', segment: 'schedule' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3, link4]);
        ...
        it('should return a segment for the secondary id even if it has the same name as a router link advanced', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'about', segment: 'about/:id' };
            const link2 = { component: mock_providers_1.MockView1, name: 'schedule', segment: 'schedule/paramOne/:paramOne/paramTwo/:paramTwo' };
            const link3 = { component: mock_providers_1.MockView1, name: 'ThirdPage', segment: 'third-page' };
            const link4 = { component: mock_providers_1.MockView1, name: 'FourthPage', segment: 'fourth-page/object/:objectId' };
            const link5 = { component: mock_providers_1.MockView1, name: 'taco-page', segment: 'taco-page' };
            const links = url_serializer_1.normalizeLinks([link1, link2, link3, link4, link5]);
    ...
    describe('convertUrlToSegments', () => {
        it('it should return a vanilla single segment', () => {
            const link1 = { component: mock_providers_1.MockView1, name: 'login-page', segment: 'login-page' };
            const link2 = { component: mock_providers_1.MockView1, name: 'settings-page', segment: 'settings-page' };
            const link3 = { component: mock_providers_1.MockView1, name: 'details-page', segment: 'details-page' };
            const mockNav = mock_providers_1.mockNavController();
            serializer._app.registerRootNav(mockNav);
            const links = url_serializer_1.normalizeLinks([link1, link2, link3]);
            const url = 'settings-page';
            const segments = url_serializer_1.convertUrlToSegments(serializer._app, url, links);
...
function mockSerializer(navLinks) {
    let deepLinkConfig = mock_providers_1.mockDeepLinkConfig(navLinks);
    return new url_serializer_1.UrlSerializer(mock_providers_1.mockApp(), deepLinkConfig);
}
