...
const picker_options_1 = require("./picker-options");
 ...
 * @hidden
 */
let PickerColumnCmp = class PickerColumnCmp {
    ...
    pointerMove(ev) {
        ev.preventDefault();
        ev.stopPropagation();
        let currentY = dom_1.pointerCoord(ev).y;
    ...
    pointerEnd(ev) {
        ...
        let endY = dom_1.pointerCoord(ev).y;
    ...
    refresh() {
        ...
        const selectedIndex = util_1.clamp(min, this.col.selectedIndex, max);
