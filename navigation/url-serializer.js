...
class UrlSerializer {
    ...
    serializeComponent(navContainer, component, data) {
        if (component) {
            const link = exports.findLinkByComponentData(this.links, component, data);
            if (link) {
...
exports.isPartMatch = (urlPart, configLinkPart) => {
...
exports.createMatchedData = (matchedUrlParts, link) => {
    let data = null;
...
exports.findLinkByComponentData = (links, component, instanceData) => {
    let foundLink = null;
