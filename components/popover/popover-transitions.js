 ...
 */
class PopoverTransition extends page_transition_1.PageTransition {
...
class PopoverPopIn extends PopoverTransition {
    init() {
        ...
        let wrapper = new animation_1.Animation(this.plt, ele.querySelector('.popover-wrapper'));
...
class PopoverMdPopIn extends PopoverTransition {
    init() {
        let ele = this.enteringView.pageRef().nativeElement;
        let content = new animation_1.Animation(this.plt, ele.querySelector('.popover-content'));
        let viewport = new animation_1.Animation(this.plt, ele.querySelector('.popover-viewport'));
