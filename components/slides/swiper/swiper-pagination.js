...
function updatePaginationClasses(s) {
    ...
    if (s.paginationType === 'fraction') {
        swiper_utils_1.eachChild(s._paginationContainer, '.' + swiper_utils_1.CLS.paginationCurrent, (ele) => {
            ele.textContent = (current + 1);
        });
        swiper_utils_1.eachChild(s._paginationContainer, '.' + swiper_utils_1.CLS.paginationTotal, ele => {
    ...
    if (s.paginationType === 'progress') {
        ...
        swiper_utils_1.eachChild(s._paginationContainer, '.' + swiper_utils_1.CLS.paginationProgressbar, ele => {
