...
const swiper_transition_1 = require("./swiper-transition");
const swiper_progress_1 = require("./swiper-progress");
const swiper_classes_1 = require("./swiper-classes");
const swiper_parallax_1 = require("./swiper-parallax");
const swiper_index_1 = require("./swiper-index");
const swiper_effects_1 = require("./swiper-effects");
const swiper_pagination_1 = require("./swiper-pagination");
const swiper_zoom_1 = require("./swiper-zoom");
function initSwiper(s, plt) {
    ...
    const containerModifierClass = swiper_utils_1.CLS.containerModifier;
...
function createLoop(s) {
    ...
    swiper_utils_1.eachChild(s._wrapper, '.' + swiper_utils_1.CLS.slide + '.' + swiper_utils_1.CLS.slideDuplicate, ele => {
...
function onTransitionEnd(s, plt, runCallbacks = true) {
    s._animating = false;
    swiper_transition_1.setWrapperTransition(s, plt, 0);
    if (runCallbacks) {
        s._zone.run(() => {
