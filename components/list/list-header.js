 ...
 * @hidden
 */
let ListHeader = class ListHeader extends ion_1.Ion {
...
ListHeader = __decorate([
    ...
    __param(3, core_1.Attribute('id')),
    __metadata("design:paramtypes", [config_1.Config, core_1.Renderer, core_1.ElementRef, String])
], ListHeader);
