...
describe('VirtualScroll', () => {
    ...
    describe('estimateHeight', () => {
        it('should return zero when no records', () => {
            const h = virtual_util_1.estimateHeight(0, undefined, 100, .25);
            expect(h).toEqual(0);
        });
    });
    ...
    describe('populateNodeData', () => {
        it('should set no nodes when no records', () => {
            ...
            let endCellIndex = 0;
            virtual_util_1.populateNodeData(startCellIndex, endCellIndex, true, cells, records, nodes, viewContainer, itmTmp, hdrTmp, ftrTmp, false);
        ...
        it('should create nodes', () => {
            ...
            let startCellIndex = 2;
            let endCellIndex = 4;
            virtual_util_1.populateNodeData(startCellIndex, endCellIndex, true, cells, records, nodes, viewContainer, itmTmp, hdrTmp, ftrTmp, true);
    ...
    describe('getVirtualHeight', () => {
        it('should return known height from last cell/record', () => {
            ...
            let virtualHeight = virtual_util_1.getVirtualHeight(totalRecords, lastCell);
